      ...
      <div className="flex-parent-centered">
        <div id={ABOUT_POPUP_ID} className="popup-dialog">
          ...
          <div className="popup-dialog-content">
            ...
            <p>
              It is a proof of concept that one could build relatively complex apps using Raycast,
              without using any of the "classic" React event handlers.
            </p>
