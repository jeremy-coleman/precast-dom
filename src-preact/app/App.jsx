...
export class App extends Component {
    ...
    // componentDidMount() {
    //     rootNode = ReactDOM.findDOMNode(this.rootRef);
    //     canvasNode = ReactDOM.findDOMNode(this.canvasRef);
    // }
    //</editor-fold>
    ...
    handleMouseOrTouchMove(ray, isTouch) {
        ...
        if (!isTouch && ray.e.altKey && ray.intersects(this.rootRef.current)) { // Alt + mouse move = new circle
            this.setState({
