...
function combine(streams, opts) {
    ...
    if (streams.length == 0)
        ...
        return streams[0];
    var first = streams[0], last = streams[streams.length - 1], thepipe = duplexer(opts, first, last);
...
export { from2, fromString, mergeStreams, concat, combiner, SinkStream, Splicer as StreamSplicer, duplex2, StreamCombiner, ReadOnlyStream, ConcatStream, through, throughClassic, Labeled as LabeledStreamSplicer, 
//aliases
